...
# plot for different number of vertices
...
for i in range(3):
    ...
    plt.plot(shortest_plot, shortest_length_array[:, i], color=color_list[i], label=f'Vertices = {vertex_list[i]}')
plt.xlabel("Iteration")
plt.ylabel("Path length")
plt.title("Path length vs iteration nr")
plt.legend()
