...
connections, vertice_array_x, vertice_array_y, distance_matrix, weight_matrix, pheromone_matrix = \
...
pos1 = ax[0].pcolormesh(connections, cmap='gray_r', edgecolors='darkgreen', linewidth='0.01')
